...
1. **Describe the barrier clearly**: What specifically was the problem?
2. **Explain impact on goals**: How did this affect progress?
3. **Document actions taken**: What did you do to address it?
4. **Note outcome**: Was the issue resolved? What remains outstanding?
5. **Provide recommendations**: What would help in the future?
...
>
> 1. **Continuation of OT services** (2 hours/fortnight) to consolidate gains and work on advanced meal preparation and household management
> 2. **Increase in community participation hours** from 4 to 8 hours weekly to support [Participant]'s expressed desire for increased social connections and community involvement
> 3. **Exploration of Supported Independent Living** options, with SIL assessment to be completed in next plan period
> 4. **Reduction in support coordination hours** from 100 to 60 hours, as [Participant] has developed strong self-advocacy skills and provider relationships"
...
[ ] Provider reports attached
[ ] Allied health assessments attached
[ ] Functional capacity assessment attached
...
1. **Continue current successful supports** with stable, quality providers who have developed strong relationships with Sarah
2. **Add employment supports** through School Leaver Employment Supports (SLES) or equivalent, aligned with Sarah's expressed interest in working at an art gallery or craft store
3. **Expand travel training** to additional routes supporting employment and education goals
4. **Reduce support coordination** reflecting Sarah's growing independence and advocacy skills
5. **Explore TAFE options** for art-related courses to build toward employment goals
...
- [NDIS Support Coordination Pricing Guide 2024-25](/blog/ndis-support-coordination-pricing-guide-2024-25/)
- [NDIS Progress Notes Template](/blog/ndis-progress-notes-template-download-guide/)
- [How to Request an NDIS Plan Review](/blog/how-to-request-ndis-plan-reviews-better-support/)
- [NDIS Support Plan Template](/blog/ndis-support-plan-template-download-guide/)
- [Free NDIS Invoice Template](/blog/ndis-invoice-template-free-download-guide/)
