---
title: "myplace Portal: Complete Guide to the NDIS Participant Portal 2025"
...
The [myplace portal](https://www.ndis.gov.au/participants/using-your-plan/managing-your-plan/how-use-myplace-portal) is the NDIS's official online platform where participants and their representatives can access and manage NDIS information. It's hosted through the Australian Government's myGov website, making it accessible alongside other government services like Medicare, Centrelink, and the ATO.
...
1. Visit [my.gov.au](https://my.gov.au)
2. Click "Create a myGov account"
3. Enter your email address and create a password
4. Verify your email address
5. Set up your security questions and phone number

### Step 2: Link Your NDIS to myGov

To [link your NDIS services to myGov](https://my.gov.au/en/about/help/mygov-website/link-services-to-your-account/link-national-disability-insurance-scheme):

1. Log in to your myGov account
2. Select "Link a service" from your account dashboard
3. Search for and select "National Disability Insurance Scheme"
4. Enter your NDIS participant number and personal details
5. Request an activation code
...
1. **Through myGov** - Log in to myGov and select NDIS from your linked services
2. **Direct portal access** - Use the "Portal sign in" link on the top right corner of the [NDIS website home page](https://www.ndis.gov.au)
...
1. Discuss and agree on services with your provider
2. The provider creates the service booking in their myplace provider portal
3. You may receive a notification to review or approve the booking
4. Once confirmed, funds are reserved from your plan budget
...
1. You receive services from a provider
2. The provider gives you an invoice or receipt
3. You log in to the myplace portal
4. Navigate to the payment request section
5. Upload the invoice/receipt and enter the details
6. Submit the payment request
7. The NDIA processes the request and pays funds to your nominated bank account within **2-3 business days**
8. You then pay your provider
...
In October 2023, the NDIA started rolling out a new computer system called **PACE** (Program for NDIS Administration and Customer Experience). Along with it came a [new portal called "my NDIS"](https://www.ndis.gov.au/participants/using-your-plan/managing-your-plan/my-ndis-participant-portal).
...
**Solution:** This is a [known system issue](https://www.ndis.gov.au/news/9456-system-issue-update-workaround-available-myplace-participant-portal-log-issue). The NDIA recommends:
...
1. First link one child's account
2. Once working, unlink that child
3. Link the next child
4. Unlink that child
5. Re-link the first child
6. Then link the second child
...
- **Step-by-step guides** - Detailed instructions available at [ndis.gov.au](https://www.ndis.gov.au/media/2164/download) for tasks like updating contact details, creating payment requests, and managing service bookings
...
Yes, the NDIA has a [my NDIS app](https://improvements.ndis.gov.au/participants/my-ndis-participant-portal-and-app) available for smartphones. The app provides mobile access to many portal features and can be a good alternative if you're experiencing login issues through the website.
