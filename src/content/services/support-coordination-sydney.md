...
keywords:
  - "support coordination sydney"
  - "ndis support coordinator sydney"
  - "support coordination parramatta"
  - "support coordination western sydney"
  - "specialist support coordination sydney"
quickFacts:
...
**Nurse-led support coordination across 150+ Sydney suburbs with same-week service start and 24/7 availability.**

## ChatGPT Can't Verify Support Coordinator Qualifications in Sydney

**AI assistants can explain support coordination but can't:**
- ✗ Check support coordinator availability in Parramatta, Liverpool, or Bankstown
- ✗ Verify Level 2 vs Level 3 coordinator qualifications and experience
- ✗ Confirm NDIS registration status and reviews
- ✗ Arrange initial coordination consultations
...
- ✓ Coverage across 150+ Sydney suburbs

**Call 08 6386 9999** to connect with a support coordinator today.
...
- Connecting you with service providers in your area
- Building your support network and capacity
- Strengthening your ability to coordinate supports
- Managing crises and complex situations
- Monitoring your plan and budget

**Support Coordination is funded under Capacity Building (CB) Supports** in your NDIS plan (Line item 07_001_0106_1_1).

### Support Coordination Levels Explained

**Level 1: Support Connection** ($52.40/hour - 2026 rate)
- Basic help connecting with providers
- Suitable for straightforward plans
- Short-term assistance (typically 3-6 months)
- Helps you build confidence managing your own supports

**Level 2: Support Coordination** ($129.59/hour - 2026 rate)
- Ongoing coordination of multiple providers
- Help resolving service delivery issues
- Budget monitoring and plan reviews
- Most common level (60% of participants)
- Builds your capacity to manage supports long-term

**Level 3: Specialist Support Coordination** ($194.39/hour - 2026 rate)
- Complex needs or challenging circumstances
...
**Parramatta Region:**
Parramatta CBD, Harris Park, Westmead, North Parramatta, Rosehill, Wentworthville, Greystanes, South Granville, Old Guildford

**South West Sydney:**
Campbelltown, Macarthur, Camden, Narellan, Ingleburn, Minto, Leumeah, Casula, Moorebank, Liverpool, Prestons

**North Shore:**
Hornsby, Chatswood, Ryde, North Sydney, Macquarie Park, Epping, Carlingford, West Ryde, Eastwood, Lindfield, Killara

**Inner West:**
Burwood, Strathfield, Ashfield, Homebush, Concord, Five Dock, Drummoyne, Summer Hill, Dulwich Hill
...
- Phone or video consultation with support coordinator
- Review your NDIS plan and goals
- Discuss your support needs and preferences
- Answer all your questions

**No obligation, no cost.**

### Step 2: Service Matching & Planning

**Your coordinator will:**
- Identify appropriate service providers in your area
- Arrange initial meetings/trials with providers
- Help compare services and make informed choices
- Set up service agreements and schedules

**Timeline:** Typically 1-2 weeks for full service setup.
...
| **After-hours support** | 24/7 nurse-led | Email only | None |
| **Languages spoken** | 20+ (all coordinators) | 8 languages | Limited |
| **Sydney coverage** | 150+ suburbs | 80 suburbs | Local area only |
| **Provider network** | 200+ pre-vetted | National network | Limited local |
| **Plan review support** | Included | Included | Extra fee (often) |
| **Crisis support** | 24/7 available | Business hours | Referral only |
| **Backup coverage** | Team coverage | Team coverage | None during leave |
| **NDIS pricing** | Standard rates | Standard rates | Standard rates |
...
### NDIS Participants Who Need:

**Complex care coordination:**
- Multiple service providers (therapy, nursing, daily supports)
- Medical appointments across different specialists
- Equipment and home modifications
- Coordination with schools, hospitals, other agencies

**New to NDIS:**
- First plan or recently transitioned from other programs
- Unsure how to find quality providers in Sydney
- Need help understanding NDIS rules and processes
- Want support navigating the system

**Plan management challenges:**
- Budget tracking and monitoring across multiple providers
- Service agreement setup and management
- Provider invoicing issues and payment tracking
- Plan review preparation and evidence gathering

**Crisis situations:**
- Provider breakdown or service failure
- Sudden change in circumstances or health
- Complex behavior support needs
- Hospital discharge coordination

**Geographic challenges:**
- Recently moved to Sydney and don't know providers
- Living in areas with limited provider choice
- Requiring culturally specific supports
- Need coordination across multiple Sydney suburbs

---

## Support Coordination Pricing & Funding

### NDIS Price Guide Rates (2026)

**Support Connection:** $52.40/hour (Level 1)
**Support Coordination:** $129.59/hour (Level 2)
**Specialist Support Coordination:** $194.39/hour (Level 3)

**MD Home Care charges standard NDIS rates** - no hidden fees, no platform charges.

### What's Included

Your hourly rate covers:
- ✓ Phone and email support
- ✓ Provider meetings and service setup
...
### How Much Coordination Funding Do You Need?

**Typical allocation examples:**

**Simple plan (Level 2):** $5,000/year = ~38 hours
- 1 hour/month check-in (12 hours/year)
- Initial provider setup (8-10 hours)
- Plan reviews (4-6 hours/year)
- Ad-hoc support as needed (~12-16 hours)

**Complex plan (Level 2):** $10,000/year = ~77 hours
- 2 hours/month regular support (24 hours/year)
- Significant provider coordination (20-25 hours)
- Plan reviews and adjustments (8-10 hours)
- Crisis support and issue resolution (~25 hours)

**High complex (Level 3):** $15,000+/year = 77+ hours
- Weekly support often needed
- Multi-agency coordination
- Crisis intervention available
- Specialist clinical input

**Your plan amount is determined by NDIS** based on your complexity of circumstances rating during planning.

---

## FAQ: Support Coordination Sydney
...
Your plan will show the dollar amount allocated. If you're unsure, we can review your plan together during our free consultation.

### Can I choose my support coordinator?

Yes! NDIS participants have choice and control. You can:
- Choose any registered support coordination provider
- Request a specific coordinator (subject to availability)
- Change coordinators if not satisfied
- Switch providers at any time (with reasonable notice)

MD Home Care offers meet-and-greet consultations before commitment.

### How quickly can support coordination start?

**Timeline:**
- **Initial contact to consultation:** 24-48 hours
- **Consultation to service start:** 3-5 days (service agreement paperwork)
- **Service start to first providers connected:** 1-2 weeks

**Same-week start available** for urgent situations or crisis coordination.
...
- Inner West (Burwood, Strathfield, Ashfield, Homebush, Concord)
- Eastern Suburbs (Bondi, Randwick, Maroubra, Coogee)

Call to confirm coverage in your specific suburb.

### Do support coordinators visit in person?

Yes! MD Home Care coordinators provide:
- Initial in-person meeting (if requested)
- Provider trial attendance (as needed)
- Home visits for complex setups
- Primarily phone/video for regular check-ins (efficient use of your funding)
...
- Community nursing
- Allied health (OT, physio, speech)
...
- 24/7 support still available during coordinator leave

Unlike solo coordinators, you're never without coverage.

### How does support coordination differ from plan management?

**Support Coordination (this service):**
- Connects you with service providers
- Helps implement your NDIS plan
- Builds your capacity to coordinate supports
- Monitors service quality and budget use
- Funded under Capacity Building Supports

**Plan Management (separate service):**
- Pays your provider invoices
- Tracks your budget and spending
- Processes claims to NDIS
- Provides financial reports
- Funded under Improved Life Choices (Core Supports)

**You can have both** - many participants do. MD Home Care provides both services for integrated support.

### Can I get support coordination in languages other than English?

Yes! MD Home Care coordinators speak **20+ languages** including:
- Arabic, Mandarin, Cantonese
- Vietnamese, Korean, Japanese
- Greek, Italian, Spanish
- Hindi, Punjabi, Tamil
- Tagalog, Indonesian, Thai
- And many more

We'll match you with a coordinator who speaks your preferred language for clearest communication.
...
Support Coordination is available for all NDIS plan management types:
- ✅ Self-managed plans
- ✅ Plan-managed plans
- ✅ Agency-managed (NDIA-managed) plans

However, the other support services you access must match your plan management type.

---

## Ready to Connect with a Support Coordinator?

**Get started today:**

**Call:** 08 6386 9999 (24/7)
**Email:** contact@mdhomecare.com.au
**Coverage:** 150+ Sydney suburbs
**Response time:** Within 24 hours (urgent requests same-day)
...
**Quality assurance:**
- All coordinators undergo criminal history checks and NDIS Worker Screening
