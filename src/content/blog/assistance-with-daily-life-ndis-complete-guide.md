---
title: "Assistance with Daily Life NDIS: Complete Funding Guide 2025"
description: "Complete guide to NDIS Assistance with Daily Life funding in 2025. Covers eligibility, support item codes (01_011, 01_019), hourly rates ($70.23), what's included, and how to maximise your Core Support budget."
pubDate: 2025-12-16
author: "Camila"
...
| Activity | Examples |
|----------|----------|
| Personal hygiene | Showering, bathing, oral hygiene, grooming |
| Dressing | Putting on clothes, fastening buttons, choosing appropriate clothing |
| Toileting | Assistance with using the toilet, continence management |
| Eating and drinking | Meal assistance, feeding support, swallowing supervision |
| Mobility | Transfers, repositioning, walking assistance |
| Medication | Reminders, prompting (non-clinical administration) |
...
### Accommodation-Related Supports
...
| Line Item Code | Description | Price Limit |
|----------------|-------------|-------------|
| 01_021_0115_1_1 | Group Personal Care - Weekday Daytime | $70.23/hr |
| 01_022_0115_1_1 | Group Personal Care - Weekend | $98.83/hr |
| 01_023_0115_1_1 | Group Personal Care - Sleepover | $297.60/night |

For a complete list of all NDIS line item codes, see our [NDIS Line Items Guide 2024-25](/blog/ndis-line-items-guide-2024-25/).
...
| Short Notice Cancellation | Up to 100% of service cost |
| NDIA-Requested Reports | $70.23/hr |

> **Note:** These are maximum price limits. Plan-managed and self-managed participants can negotiate lower rates with providers. For complete pricing details, see our [NDIS Price Guide 2025-26](/blog/ndis-price-guide/).
...
| Feature | Assistance with Daily Life | Improved Daily Living |
|---------|---------------------------|----------------------|
| **Funding Type** | Core Support | Capacity Building |
| **Purpose** | Help you do tasks NOW | Build skills for FUTURE independence |
| **Examples** | Support worker helps you shower | OT teaches you to shower safely |
| **Flexibility** | Flexible within Core budget | Fixed to specific category |
| **Goal** | Maintain current lifestyle | Reduce need for support over time |
...
|---------------|---------------------|
| Functional assessment | Which daily tasks you need help with |
| Medical reports | How your disability affects daily living |
| Allied health reports | Specific support requirements |
| Current support hours | What assistance you already receive |
| Goals | How the support helps achieve your NDIS goals |
...
|---------------|----------|----------------|
| Registered Provider | NDIA-managed participants, complex care | Must follow price limits |
| Unregistered Provider | Plan-managed, self-managed | May offer lower rates |
| Individual Worker | Flexibility, continuity | Self-managed only |
| Family Member | Familiar support | Restrictions apply |
...
|----------|---------|-------------|
| **Assistance with Daily Life** | Personal care, household tasks, accommodation support | Flexible |
| **Consumables** | Everyday disability-related items | Flexible |
| **Assistance with Social & Community Participation** | Community access, social activities | Flexible |
| **Transport** | Getting to activities and appointments | Generally flexible |

For a comprehensive overview of all Core Supports, see our [NDIS Core Supports Guide](/blog/ndis-core-supports/).
...
- [NDIS Pricing Arrangements 2025-26](https://www.ndis.gov.au/providers/pricing-arrangements) - Official price guide
- [NDIS Support Catalogue](https://www.ndis.gov.au/providers/pricing-arrangements) - Complete list of funded supports
- [NDIS Provider Finder](https://www.ndis.gov.au/participants/working-providers/find-registered-provider) - Search for providers
