...
Before documenting:
1. Ensure the participant is safe
2. Provide necessary first aid or medical care
3. Contact emergency services if required
4. Secure the scene or remove hazards
5. Comfort and support the participant
...
Using our template:
1. Fill in incident date, time, and location
2. Record participant and reporter information
3. Classify the incident type and severity
4. Write a detailed factual description
5. List all witnesses and their contact details
6. Document immediate actions taken
7. Describe injuries or impact
8. Record all notifications made
9. Identify required follow-up actions
...
1. Log in to the NDIS Commission portal (providers.ndiscommission.gov.au)
2. Navigate to "Incident Management System"
3. Click "Create New Incident Notification"
...
**Immediate Actions:**
1. Call 000 for ambulance
2. Comfort participant, do not move them
3. Take basic observations (conscious, breathing)
4. Contact family/nominee
...
**Immediate Actions:**
1. Remove worker from the situation
2. Support and reassure participant
3. Check participant's emotional state
4. Report to manager immediately
5. Contact family/nominee
...
**Immediate Actions:**
1. Give medication as soon as error discovered
2. Check participant for any adverse effects
3. Consult medication chart and prescriber if unsure
4. Monitor participant closely
...
**Immediate Actions:**
1. Separate the participants immediately
2. Check for injuries
3. Provide first aid if needed
4. Support both participants
...
### Investigation Steps
1. **Gather all information**: Interview witnesses, review documents, inspect the scene
2. **Analyze contributing factors**: What led to the incident?
3. **Identify root causes**: Why did these factors exist?
4. **Develop preventive actions**: How can we prevent this happening again?
5. **Implement changes**: Put new measures in place
6. **Monitor effectiveness**: Check that changes are working
...
**What if I'm not sure whether to report an incident?**
When in doubt, report it. Over-reporting is better than under-reporting. Your manager can determine if NDIS Commission notification is required.

**Can I be punished for reporting an incident?**
No. Victimization for reporting incidents is prohibited. Providers must foster a culture of open reporting.

**What if the participant asks me not to report?**
You must still report. Some incidents are mandatory to report regardless of the participant's wishes, particularly those involving harm or safety.

**How long do we need to keep incident reports?**
At least 7 years. The NDIS Commission may audit incident records during this period.

**What if an incident involves staff misconduct?**
Report it following the same process. Your organization will also need to follow employment procedures, which may include disciplinary action or police notification.

**Do we report near-misses?**
While near-misses don't require NDIS Commission reporting, they should be recorded internally as they provide valuable information for preventing future incidents.

**What if a participant self-harms?**
Self-harm incidents must be reported to the NDIS Commission if they result in serious injury or are part of a pattern requiring intervention.

**Can families see incident reports?**
Participants and their families have the right to information about incidents involving the participant. Provide reports in an accessible format while protecting privacy of others involved.

## Key Resources for NDIS Incident Reporting
- [NDIS Commission Incident Management](https://www.ndiscommission.gov.au/providers/incident-management)
- [Reportable Incidents Rules](https://www.ndiscommission.gov.au/resources/reports-and-policies/reportable-incidents-rules)
- [NDIS Commission Portal](https://providers.ndiscommission.gov.au)
- [NDIS Practice Standards - Incident Management](https://www.ndiscommission.gov.au/providers/registered-ndis-providers/provider-obligations-and-requirements/ndis-practice-standards)
